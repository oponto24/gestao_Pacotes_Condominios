...
| 1.5 | Integração Clerk (sign-in/sign-up + webhook user provisioning) | **Ready for Review** 🔍 (parcial — aguardando webhook setup) | 1.3, 1.4 |
...
| # | Story | Status | Dependência |
|---|-------|--------|-------------|
| 2.1 | CRUD Condominio (super-admin only) | Draft | 1.6 |
