...
import { labelExtractionSchema } from '../src/lib/anthropic/schemas/label-extraction';
import { LABEL_EXTRACTION_SYSTEM_PROMPT } from '../src/lib/anthropic/prompts/label-extraction';
...
const SAMPLES: Array<{ file: string; label: string }> = [
  ...
  { file: 'pacote_teste.jpeg', label: 'Pacote real (Mercado Livre Flex)' },
];
